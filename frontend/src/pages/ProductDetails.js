...
const ProductDetails = () => {
  const [data, setData] = useState({
    ...
    price: "",
    sellingPrice: "",
    reviews: [], // Add reviews to the state
  });
  ...
  const reviewSectionRef = useRef(null); // Ref for review section
  ...
  return (
    <div className="container mx-auto p-4">
        ...
        {loading ? (
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="flex items-center gap-3 my-2">
              <button
                className="border-2 border-green-600 rounded px-3 py-1 min-w-[120px] text-white font-medium hover:bg-green-600 hover:text-green"
      ...
      {/* Review Section */}
      <div id="reviewSection" ref={reviewSectionRef}>
        {showReviewForm && <ReviewPage reviews={data?.reviews || []} />}
      </div>
    </div>
  );
};
